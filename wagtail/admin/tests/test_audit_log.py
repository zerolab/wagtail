...
from wagtail.core.models import LogEntry, Page, PageViewRestriction, GroupPagePermission
...
class TestAuditLogAdmin(TestCase, WagtailTestUtils):
    ...
    def test_page_history(self):
        ...
        self.assertContains(response, 'Updated the view restriction to &#x27;Private, accessible with the following password&#x27;')

        self.assertContains(response, 'system', 1)  # create without a user
